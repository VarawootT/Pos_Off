...
@$result = $mysqli->query("SELECT count(id) as countType,sum(receive) as qty, pay FROM `p_so_h` WHERE date(date_so) BETWEEN '$i_DATE1' AND '$i_DATE2' $SE_USERH $SE_WH");
while ($row_dis = $result->fetch_assoc()) {
...
@$resultsta = $mysqli->query("SELECT count(id) as countsta,sum(receive) as qty FROM `p_so_h` WHERE sta = '0' AND date(date_so) BETWEEN '$i_DATE1' AND '$i_DATE2' $SE_USERH $SE_WH");
while ($row_sta = $resultsta->fetch_assoc()) {
            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <div class="small-box bg-success">
                        <div class="inner">
                            <h3>เงินสด</h3>
                            <h5>จำนวนคู่ : <?php echo $CReceived; ?></h5>
                ...
                <div class="col-md-4 accent-dangercol-sm-12">
                    <div class="small-box bg-warning">
                        <div class="inner">
                            <h3>บัตรเครดิต</h3>
                            <h5>จำนวนคู่ : <?php echo $CIssued; ?></h5>
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="small-box bg-info">
                        <div class="inner">
                            ...
                            <h5>จำนวนคู่ :<?php echo $CTransfer; ?></h5>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="small-box bg-danger">
                        <div class="inner">
                            <h3>ยกเลิก</h3>
                            <h5>จำนวนคู่ : <?php echo $stacount; ?></h5>
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="small-box bgblue">
                        <div class="inner">
                            <h3>รวมการขาย</h3>
                            <h5>จำนวนคู่ : <?php echo $sta0count; ?></h5>
                ...
                <div class="col-md-4 accent-dangercol-sm-12">
                    <div class="small-box bg-primary">
                        <div class="inner">
                            <h3>รวมทั้งหมด</h3>
                            <h5>จำนวนคู่ : <?php echo $sumpayall; ?></h5>
